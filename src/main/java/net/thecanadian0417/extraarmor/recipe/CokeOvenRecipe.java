...
public class CokeOvenRecipe extends AbstractCookingRecipe {
    public CokeOvenRecipe(ResourceLocation pId, String pGroup, CookingBookCategory pCategory, Ingredient pIngredient, ItemStack pResult, float pExperience, int pCookingTime)
    {
    ...
    {
        return new ItemStack(ModBlocks.COKE_OVEN.get());
    }
    ...
    public static class Serializer implements RecipeSerializer<CokeOvenRecipe> {
        ...
        public static final CokeOvenRecipe.Serializer INSTANCE = new Serializer(50);
